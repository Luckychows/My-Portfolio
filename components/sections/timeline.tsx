  ...
  return (
    <section id="experience" className="px-5 py-24 sm:px-8">
      <div className="mx-auto max-w-5xl">
        <Reveal>
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-200">Experience & Achievements</p>
          <h2 className="mt-4 font-display text-4xl font-semibold text-white sm:text-6xl">Signals recruiters can scan fast.</h2>
        </Reveal>
        <div className="relative mt-14 space-y-8 before:absolute before:left-5 before:top-0 before:h-full before:w-px before:bg-gradient-to-b before:from-cyan-300 before:via-violet-400 before:to-transparent sm:before:left-1/2">
