  ...
  return (
    <section id="resume" className="px-5 py-24 sm:px-8">
      <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[.8fr_1.2fr]">
        <Reveal>
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-red-200">Resume</p>
            <h2 className="mt-4 font-display text-4xl font-semibold text-white sm:text-6xl">Experience & Achievements</h2>
            <p className="mt-6 leading-8 text-slate-300">
              A comprehensive overview of cybersecurity expertise, project depth, technical skills, certifications, and hands-on SOC/cloud security operations experience.
            </p>
        ...
        <Reveal delay={0.1}>
          <div className="glass overflow-hidden rounded-lg">
            <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
              ...
              <span className="rounded-full border border-white/10 px-3 py-1 text-xs text-slate-400">PDF</span>
            </div>
            <div className="p-6">
              <div className="rounded-lg border border-white/10 bg-slate-950/70 p-6">
                ...
                <p className="mt-2 text-red-200">{resume.headline}</p>
